/*
    Rotilio.cc firmware base modified for hackster tutorial "Rotilio:how to publish sensor data to Facebook with a click"
    by stefano@techmakers.io
    for more information head on
    https://www.hackster.io/Techmakers/rotilio-how-to-publish-sensor-data-to-facebook-with-a-click-e7730e
...
void loop(){
    ...
    if (actualButton1 == LOW){
        ...
        publishTemperature(String(temperature));
    }
...
void publishTemperature(String temperature){
    Particle.publish("publishTemperature",temperature,60,PRIVATE) ;
}
...
void loop(){
    ...
    if (actualButton1 == LOW){
        ...
        button1 = !button1 ;
        sendVariableChanged("button1",button1 ? "1" : "0");
        publishTemperature("button1",button1 ? "1" : "0");
    }
...
void publishTemperature(String name, String value){
    Particle.publish("publishTemperature","TEMPERATURE: "+String(temperature),60,PRIVATE) ;
}
